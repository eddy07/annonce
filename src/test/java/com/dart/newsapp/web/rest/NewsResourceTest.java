...
import com.dart.newsapp.Application;
...
public class NewsResourceTest {
    ...
    public void initTest() {
        ...
        news.setPublicationDate(DEFAULT_PUBLICATION_DATE);
    ...
    public void createNews() throws Exception {
        ...
        assertThat(testNews.getPublicationDate().toDateTime(DateTimeZone.UTC)).isEqualTo(DEFAULT_PUBLICATION_DATE);
    ...
    public void getAllNewss() throws Exception {
        ...
        restNewsMockMvc.perform(get("/api/newss"))
                ...
                .andExpect(jsonPath("$.[0].publicationDate").value(DEFAULT_PUBLICATION_DATE_STR))
    ...
    public void updateNews() throws Exception {
        ...
        news.setPublicationDate(UPDATED_PUBLICATION_DATE);
        ...
        assertThat(testNews.getPublicationDate().toDateTime(DateTimeZone.UTC)).isEqualTo(UPDATED_PUBLICATION_DATE);
